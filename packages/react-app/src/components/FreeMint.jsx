...
export default function FreeMint({ address, web3Modal, loadWeb3Modal, readContracts, writeContracts, tx }) {
  const [saleState, setSaleState] = useState("freeMints");
        ...
        <div className="content">
          ...
          <div style={{ alignSelf: "center" }} className="rightContent">
            {!web3Modal.cachedProvider ? (
              ...
              <div className="subHeader">Congratulations! You have free mints.</div>
            )}
            ...
            <div style={{ color: "#A0A0A0", marginTop: "3%", marginBottom: "5.5%" }} className="webBody3">
              You have till April 5th 11AM EST left to claim your rices.
            </div>
            {web3Modal.cachedProvider ? (
              <div onClick={()=>devMint()} className="primaryButton">Claim my Rices!</div>
            ) : (
              <div onClick={loadWeb3Modal} className="primaryButton">
                Connect Wallet
              </div>
