...
import comboSticker8 from "../stickers/comboSticker8.png";
...
export default function FAQ() {
  ...
  return (
    <div className="FAQ">
      <img src={comboSticker8} className="stickerCol1" />
      <div className="content">
        <div className="webTitle">FAQs</div>
        <div className="listOfQuestions">
          <Accordion elevation={0} className="questionSet">
            <AccordionSummary expandIcon={<ExpandMoreIcon className="expandIcon" />} aria-controls="panel1a-content" id="panel1a-header">
        ...
        <div className="imageContainer">
          <img src={stickerBubbleTea} className="stickerTag" />
        </div>
      </div>
